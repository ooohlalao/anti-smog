...
{	
	...
	titlelist=['BEIJING AIR POLLUTION','10 FACTS ABOUT SMOG','BEST SOLUTIONS','SPREAD OUR SPIRITS WITH STYLES'];
	hreflist=['pages/1.html','pages/2.html','pages/3.html','pages/4.html'];
	...
	var text2="The Chinese capital has for many years suffered from serious air pollution. Primary sources of pollutants include exhaust emission from Beijing's more than five million motor vehicles, coal burning in neighbouring regions, dust storms from the north and local construction dust...... &nbsp;&nbsp;";
	var text3="The Chinese capital has for many years suffered from serious air pollution. Primary sources of pollutants include exhaust emission from Beijing's more than five million motor vehicles, coal burning in neighbouring regions, dust storms from the north and local construction dust...... &nbsp;&nbsp;";
